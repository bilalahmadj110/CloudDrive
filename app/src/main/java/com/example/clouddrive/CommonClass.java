...
public class CommonClass {
    ...
    public boolean validateEditText(EditText editText, String name) {
        boolean check = true;
    ...
    public void showDialog(String title, String given, Context context) {
    ...
    public void showDialog(int icon, String title, String given, Context context) {
        AlertDialog.Builder builder;
        builder = new AlertDialog.Builder(context);
    ...
    public String onError(ANError anError) {
    ...
    public void showUnAuthorized(Context context) {
        showDialog("Unauthorized request",
